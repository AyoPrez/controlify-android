...
class DummyCorruptedData {
    ...
    fun getSessionCorruptedDataListWithEmptyElements(): MutableList<SessionsData> {
        ...
        list.addAll(getJuneSessionDataWithEmptyFields())
    ...
    private fun getJuneSessionDataWithEmptyFields(): MutableList<SessionsData> {
        val sessionsDataJune1 = SessionsData().apply {
            day = "01/06/2019"
            totalDayTime = "00:05:52"
        }
        ...
        val sessionJune3_5 = Session().apply {
            startSessionTime = "21:27:50"
            endSessionTime = "22:52:17"
        }
        ...
        val sessionJune4_3 = Session().apply {
            startSessionTime = "18:48:50"
            endSessionTime = "18:52:17"
        }
        val sessionJune4_4 = Session().apply {
            startSessionTime = "22:48:50"
            endSessionTime = "23:52:17"
        }
    ...
    private fun getJuneSessionData() : MutableList<SessionsData> {
        ...
        val sessionJune1_1 = Session().apply {
            startSessionTime = "07:48:50"
            endSessionTime = "07:52:17"
            totalSessionTime = "00:03:27"
        }
        val sessionJune1_2 = Session().apply {
            startSessionTime = "08:18:20"
            endSessionTime = "08:20:45"
            totalSessionTime = "00:02:25"
        }
